...
_GAME_OBJECT_T* create_player(int32_t x_pos, int32_t y_pos){
	...
	player->clear_box_bitmap = player_erase_map;
...
_GAME_OBJECT_T* create_bullet(int32_t x_pos, int32_t y_pos){
	...
	bullet->clear_box_bitmap = erase_map;
...
_GAME_OBJECT_T* create_goose(int32_t x_pos, int32_t y_pos, int32_t x_vel, int32_t y_vel){
	...
	goose->clear_box_bitmap = erase_map;
...
bool collide(_GAME_OBJECT_T* obj1, _GAME_OBJECT_T* obj2){
	int32_t obj1_left = obj1->x_pos, obj1_right = obj1->x_pos + obj1->width, obj1_top = obj1->y_pos, obj1_bot = obj1->y_pos + obj1->height,
	...
	return (obj1_left < obj2_right && obj1_right > obj2_left && obj1_top < obj2_bot && obj1_bot > obj2_top);
